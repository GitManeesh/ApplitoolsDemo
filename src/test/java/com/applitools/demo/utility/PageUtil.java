package com.applitools.demo.utility;
...
public class PageUtil extends BasePage {
    ...
    public static Select selectDropdownValue;
    ...
    public static String getText(WebElement webElement) {
        String stringValue = "";
        try {
            stringValue = webElement.getText();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return stringValue;
    ...
    public static void webDriverWait(WebDriver driver, WebElement webElement) {
        WebDriverWait webDriverWait = new WebDriverWait(driver, Duration.ofSeconds(30));
        // webDriverWait.wait(ExpectedConditions.visibilityOf(webElement));
    }

    public static void selectByIndex(WebElement webElement, int index) {
        try {
            selectDropdownValue = new Select(webElement);
            selectDropdownValue.selectByIndex(index);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void selectOption(String choice,WebElement webElement, String text) {
        try {
            if ("byValue".equals(choice)) {
                selectDropdownValue = new Select(webElement);
                selectDropdownValue.selectByValue(text);
            }
            else if("byVisibleText".equals(choice)){
                selectDropdownValue = new Select(webElement);
                selectDropdownValue.selectByVisibleText(text);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
